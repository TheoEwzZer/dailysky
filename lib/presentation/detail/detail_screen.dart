  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: DecoratedBox(
        ...
        child: SafeArea(
          child: ListView(
            padding: const EdgeInsets.only(top: kToolbarHeight + 8, bottom: 28),
            children: [
              Center(
                child: Hero(
                  tag: heroTag,
              ...
              Center(child: Text(DateFormatting.fullDate(day.date), style: mutedStyle)),
                  ...
                  builder: (context, constraints) {
                    ...
                    final cards = <Widget>[
                      ...
                      MetricCard(
                        ...
                        label: 'Vent',
                        value: '${WeatherFormat.wind(day.windSpeed)} '
